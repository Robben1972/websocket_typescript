...
export default function LoginPage({inputNameHandler, loginHandler} : loginPagePropsType) {
    return (<div className="border-2 flex flex-col  gap-4 w-96 p-4">
        ...
        <button className="border-2 px-11 py-3 bg-blue-950 text-white" onClick={loginHandler}>Log in</button>
    </div>
    );
}
